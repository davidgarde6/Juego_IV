...
public class ComportamientoEnemigo1 : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (zonaDeteccion.objetosDetectados.Count > 0)
        {

            velocidad = 3.0f;
            transform.position = Vector2.MoveTowards(this.transform.position, zonaDeteccion.objetosDetectados[0].transform.position, velocidad * Time.deltaTime);
